---
name: documentation
description: Guidelines and instructions for generating C# extension methods usage documentation for the Maestria.Extensions.FluentCast.
---

# Maestria.Extensions.FluentCast Documentation Skill
